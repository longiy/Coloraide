...
from .HEX_OT import COLOR_OT_sync_hex, COLOR_OT_validate_hex
...
from .CHISTORY_OT import COLOR_OT_adjust_history_size, COLOR_OT_clear_history, COLOR_OT_remove_history_color
...
__all__ = [
    ...
    'COLOR_OT_sync_hex', 'COLOR_OT_validate_hex',
